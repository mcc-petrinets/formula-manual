...
\hypersetup{
  ...
  pdfauthor={The MCC 2015-2021 formula team}
}
...
\definecolor{defaultcolor}{RGB}{34,137,82}

\newcommand{\mccyear}{2023}
...
\lhead{\textcolor{rulercolor}{Model Checking Contest}\\\ \\}
...
\vfill
\centering
%\includegraphics[width=23.5cm,keepaspectratio]{../../Rules/backgroundNext.jpg}%
...
\Large
Model Checking Contest @ Petri Nets {\mccyear}
...
the tools participating in the \mccl{}, edition {\mccyear}.
...
Writing them by hand is a very time consuming task (in 2022, there was 127 models
and 1617 instances of such models).
